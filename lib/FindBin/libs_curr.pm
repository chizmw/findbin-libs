...
FindBin::libs_curr - FindBin::libs for whatever current 
version of Perl I'm working with.

=head1 SYNOPSIS

FindBin::libs uses this if the perl version ($^V) is 
not less than 5.12. This version may contain code that
is not usable with older versions of Perl.

=head1 SEE ALSO

FindBin::libs_5_8 for code that runs in older versions
of perl.
